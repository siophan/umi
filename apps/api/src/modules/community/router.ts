    ...
    async (request, response) => {
      ...
      ok(
        ...
        await createCommunityPost(
          user.id,
          request.body as CreateCommunityPostPayload,
        ),
      );
    },
  ),
...
communityRouter.get(
  ...
  asyncHandler(async (request, response) => {
    const user = getRequestUser(request);
    const sort: CommunityCommentSort =
      request.query.sort === 'newest' ? 'newest' : 'hot';
    ...
    async (request, response) => {
      ...
      ok(
        ...
        await reportCommunityPost(
          user.id,
          String(request.params.id),
          request.body as CreateCommunityReportPayload,
        ),
      );
    },
  ),
    ...
    async (request, response) => {
      ...
      ok(
        ...
        await createCommunityComment(
          user.id,
          String(request.params.id),
          request.body as CreateCommunityCommentPayload,
        ),
      );
    },
  ),
...
communityRouter.delete(
  ...
  withErrorBoundary(
    ...
    async (request, response) => {
      ...
      ok(
        response,
        await unlikeCommunityComment(user.id, String(request.params.id)),
      );
    },
  ),
);
...
communityRouter.delete(
  ...
  withErrorBoundary(
    ...
    async (request, response) => {
      ...
      ok(
        response,
        await unlikeCommunityPost(user.id, String(request.params.id)),
      );
    },
  ),
);
...
communityRouter.post(
  ...
  withErrorBoundary(
    ...
    async (request, response) => {
      ...
      ok(
        response,
        await bookmarkCommunityPost(user.id, String(request.params.id)),
      );
    },
  ),
);
...
communityRouter.delete(
  ...
  withErrorBoundary(
    ...
    async (request, response) => {
      ...
      ok(
        response,
        await unbookmarkCommunityPost(user.id, String(request.params.id)),
      );
    },
  ),
);
