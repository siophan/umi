...
export async function deletePostCascade(connection: mysql.PoolConnection, postId: string) {
...
export async function deleteCommentCascade(connection: mysql.PoolConnection, commentId: string) {
  const [commentRows] = await connection.execute<mysql.RowDataPacket[]>(
