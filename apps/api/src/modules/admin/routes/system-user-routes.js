...
import { createAdminSystemUser, getAdminSystemUsers, resetAdminSystemUserPassword, updateAdminSystemUser, updateAdminSystemUserStatus, } from '../system';
import { getRequestAdmin } from '../auth';
import { getRouteParam, toRouteHttpError } from '../route-helpers';
export function registerAdminSystemUserRoutes(adminRouter) {
