...
function normalizeGuessReviewStatus(status: string | null | undefined) {
...
function normalizeGuessRejectReason(
...
function ensureGuessPendingReview(row: GuessReviewRow) {
  if (
