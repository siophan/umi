...
import {
  ...
  mapPermissionStatus,
  mapRoleStatus,
  normalizeAdminPermissionAction,
  normalizeAdminPermissionCode,
  normalizeAdminPermissionModule,
  normalizeAdminPermissionName,
  normalizeAdminPermissionParentId,
...
import {
  ...
  collectAdminPermissionDescendantIds,
  fetchAdminPermissionById,
  fetchAdminPermissionRows,
  fetchAdminPermissionsByRole,
  fetchAdminRolesWithStats,
  findAdminPermissionByCode,
  wouldCreatePermissionCycle,
} from './system-rbac-shared';

export type { AdminPermissionAction, AdminPermissionLevel };
