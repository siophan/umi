...
import { buildGuessSummary, GUESS_ACTIVE, GUESS_PENDING_REVIEW, GUESS_REVIEW_APPROVED, GUESS_SETTLED, } from './search-shared';
/**
 ...
 */
export async function searchGuesses(query, limit) {
    const db = getDbPool();
    const like = `%${query}%`;
