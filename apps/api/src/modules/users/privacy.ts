...
import type { UserPublicProfile } from '@umi/shared';
...
export async function resolveProfileVisibility(userId: string, viewerId?: string | null) {
...
): Promise<UserPublicProfile['relation']> {
  if (!viewerId) {
    return 'none';
  }
