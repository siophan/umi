...
import { FULFILLMENT_PENDING, FULFILLMENT_PROCESSING, FULFILLMENT_SHIPPED, PHYSICAL_STATUS_CONSIGNING, PHYSICAL_STATUS_FULFILLED, PHYSICAL_STATUS_STORED, sanitizePhysicalRow, sanitizeVirtualRow, VIRTUAL_STATUS_CONVERTED, VIRTUAL_STATUS_LOCKED, VIRTUAL_STATUS_STORED, } from './warehouse-shared';
...
export async function getAdminVirtualWarehouseItemDetail(itemId) {
...
export async function getAdminPhysicalWarehouseItemDetail(itemId) {
