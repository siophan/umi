...
| `review_mode` | `代码验证` |
| `结论` | `未通过，维持 open` |
| `说明` | [apps/api/src/modules/admin/dashboard.ts:193](/Users/ezreal/Downloads/joy/umi/apps/api/src/modules/admin/dashboard.ts:193) 到 [apps/api/src/modules/admin/dashboard.ts:201](/Users/ezreal/Downloads/joy/umi/apps/api/src/modules/admin/dashboard.ts:201) 的热门竞猜查询当前仍只过滤 `g.review_status = approved`，没有限制 `g.status = active`；[apps/admin/src/pages/dashboard-page.tsx:290](/Users/ezreal/Downloads/joy/umi/apps/admin/src/pages/dashboard-page.tsx:290) 起页面仍直接以“热门竞猜”名义渲染结果。原问题仍成立。 |
